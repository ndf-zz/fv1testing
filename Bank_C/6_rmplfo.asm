...
; Output the lfo directly to DACL
	or	0x7fffff	; load max val into ACC
	cho	sof,RMP0,NA|REG,0.0	; scale ACC by xfade param
	wrax	DACL,0.0	; write to DACL
	;or	0x7fffff	; load max val into ACC
	;cho	sof,RMP0,RPTR2,0.0	; scale ACC by pitch transpose param
	cho	rdal,RMP0	; load raw RMP0 value
